...
subprocess.Popen(["python3", "/root/email-py/server/send.py", "Наблюдающий дед", "активирован"], stdout=subprocess.PIPE)
...
while True:
    ...
    if prompt == "ok\n":
        ...
        subprocess.Popen(["python3", "/root/email-py/server/send.py", "Наблюдающий дед:", "какой-то из дедов помер.", ded_status],
        ...
        subprocess.Popen(
            ["python3", "/root/email-py/server/send.py", "Наблюдающий дед:", "какой-то из дедов остановлен.", ded_status],
            stdout=subprocess.PIPE)
