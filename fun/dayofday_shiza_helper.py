# dependencies: []
"""
УСТАРЕВШИЙ скрипт для обновления картинок днядня в длюдеде, нужен скорее для ручного редкого использования и истории,
так что нужно вручную вписывать логин и пароль
"""
